...
Redmine::Plugin.register :redmine_external_issue_links do
  ...
  description 'Adds external source links to Redmine issues with icons, ordering, journal notes and REST API. Plugin: https://github.com/SKonovalovS/redmine-external-source'
